...
const marqueeMedia: MarqueeMedia[] = [
  ...
  { type: 'image', src: '/assets/db-scroll-3.jpg', title: 'N3 Max 场景视觉', detailImage: '/assets/db-detail-3.jpg' },
  { type: 'image', src: '/assets/db-scroll-4.jpg', title: '便携投影产品视觉', detailImage: '/assets/db-detail-4.jpg' },
  ...
  { type: 'image', src: '/assets/db-scroll-7.jpg', title: '家庭巨幕场景视频', detailVideo: '/assets/db-detail-7.mp4' },
    ...
    <section ref={ref} className="h-[82vh] min-h-[700px]">
      ...
      >
        <div className="mb-5 grid items-end gap-4 lg:grid-cols-[0.34fr_1fr_auto]">
          ...
          <button type="button" className="glow-button group" onClick={() => onProjectOpen(project)}>
            <span className="glow-button__shine" />
  ...
  return (
    <main className="min-h-screen overflow-x-clip bg-[#050505] font-body text-white">
      ...
      <section id="about" className="relative grid min-h-screen place-items-center overflow-hidden bg-[#050505] px-6 py-24 sm:px-10">
        ...
        <img src="/assets/about-air-1s.jpg" alt="" className="absolute left-[4%] top-[8%] hidden h-[220px] w-[170px] rotate-[-10deg] rounded-[28px] object-cover object-top opacity-70 md:block" />
        <img src="/assets/about-k3-ultra-max.jpg" alt="" className="absolute bottom-[8%] right-[6%] hidden h-[240px] w-[190px] rotate-[9deg] rounded-[28px] object-cover object-top opacity-80 md:block" />
