...
const marqueeMedia: MarqueeMedia[] = [
  { type: 'image', src: '/assets/project-kv-618.webp' },
  { type: 'video', src: '/assets/video-july15.mp4', poster: '/assets/poster-july15.webp', title: '7月15日视频作品' },
  { type: 'image', src: '/assets/project-kv-1111.webp' },
  { type: 'video', src: '/assets/video-haqu-headphones-1.mp4', poster: '/assets/poster-haqu-headphones-1.webp', title: '哈趣耳机视频作品' },
  { type: 'image', src: '/assets/marquee-qixi.webp' },
  { type: 'image', src: '/assets/marquee-makeup.webp' },
  { type: 'image', src: '/assets/project-overview.webp' },
  { type: 'image', src: '/assets/project-ip.webp' },
  { type: 'video', src: '/assets/video-haqu-headphones-2.mp4', poster: '/assets/poster-haqu-headphones-2.webp', title: '哈趣耳机视频作品 2' },
  { type: 'image', src: '/assets/page-ruby-serum.webp' },
  { type: 'image', src: '/assets/page-sunscreen.webp' },
  { type: 'image', src: '/assets/live-super.webp' },
];
...
function VideoModal({ video, onClose }: { video: MarqueeMedia | null; onClose: () => void }) {
  useEffect(() => {
        ...
        >
          ...
          >
            ...
            <video
              ...
              playsInline
            />
            {video.title && <p className="video-modal__title">{video.title}</p>}
          </motion.div>
        </motion.div>
      )}
    </AnimatePresence>
...
function MarqueeSection() {
  ...
  const [activeVideo, setActiveVideo] = useState<MarqueeMedia | null>(null);
  ...
  return (
    <section ref={ref} className="marquee-clip relative bg-[#050505] py-24 sm:py-32 lg:py-40">
      ...
      <MarqueeRow items={marqueeMedia.slice(0, 6)} x={rowOne} onVideoClick={setActiveVideo} />
      <MarqueeRow items={marqueeMedia.slice(6)} x={rowTwo} onVideoClick={setActiveVideo} reverse />
    </section>
  );
}
...
function MarqueeRow({
  ...
  reverse?: boolean;
  onVideoClick: (item: MarqueeMedia) => void;
}) {
